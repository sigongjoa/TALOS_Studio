...
def find_contours(image_path: str) -> tuple[list, np.ndarray | None]:
    """
    ...
    Returns:
        ...
        - A numpy array representing the contour hierarchy, or None if no contours are found.
    """
    ...
    # The hierarchy is returned as a 3D array, squeeze it to 2D
    return contours_as_lists, np.squeeze(hierarchy, axis=0)
